                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        switch (i){
                            case 0:
                                ...
                                break;
                            case 1:
                                Snackbar.make(view, "Libro insertado", Snackbar.LENGTH_INDEFINITE).setAction("Ok", v -> {
                                Libro.ejemplosLibros().add(libroSelec);
                                miAdaptadorPersonaliza.notifyItemInserted(Libro.ejemplosLibros().size()-1);
                                }).show();
                                break;
                            case 2:
                                Snackbar.make(view, "Estas seguro...", Snackbar.LENGTH_LONG).setAction("Si", v -> {
